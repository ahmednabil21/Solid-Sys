...
import { AgentResellerCredentialsDto, ServiceType } from '../types';
...
const ResellersPage: React.FC = () => {
  ...
  const serviceTypeLabel = (st: ServiceType) =>
    st === ServiceType.Ftth ? 'FTTH' : st === ServiceType.Sas ? 'SAS' : 'Earthlink';
