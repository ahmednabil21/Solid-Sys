...
const AgentsPage: React.FC = () => {
  ...
  const handleAddAgent = () => {
    ...
    createAgentMutation.mutate({
      ...
      sasBaseUrl: agentData.serviceType === ServiceType.Sas ? (agentData.sasBaseUrl?.trim() || undefined) : undefined,
      sasUsername: agentData.serviceType === ServiceType.Sas ? (agentData.sasUsername?.trim() || undefined) : undefined,
      sasPassword: agentData.serviceType === ServiceType.Sas ? (agentData.sasPassword?.trim() || undefined) : undefined,
  ...
  const getServiceTypeText = (type?: ServiceType) => {
    if (type == null) return '—';
    switch (type) {
      case ServiceType.Ftth: return 'FTTH';
      case ServiceType.Sas: return 'SAS';
      case ServiceType.Earthlink: return 'Earthlink';
      default: return '—';
    }
  };
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {agentData.serviceType === ServiceType.Sas ? (
                  <>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        SAS Base URL
                      ...
                      <input
                        ...
                        placeholder="مثال: https://admin.uniquefi.net"
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                      />
                    </div>
                    <div>
